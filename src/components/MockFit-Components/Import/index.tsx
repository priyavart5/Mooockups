...
import { setFile, clearFile } from '@/redux/mockFit-slices/mockFitSlice';
import { RootState } from '@/redux/store';
import { toast, Toaster } from 'react-hot-toast';

const Import = () => {
    const { importFile } = useSelector((state: RootState) => state.mockFit.present);
            ...
            <div className={styles.import}>
                <div className={styles.import_image}>
                    ...
                    <input
                        ...
                        accept="image/*, video/*"
                    />
                    <label className={styles.import_label} htmlFor="importFile">{importFile.fileName}</label>
                </div>
                {importFile.file && importFile.fileName && (
                    <>
                        <Icon
                            icon={Replace}
                            color="#EFEFEF"
